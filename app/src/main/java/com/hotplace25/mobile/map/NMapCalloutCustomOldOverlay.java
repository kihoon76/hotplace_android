...
public class NMapCalloutCustomOldOverlay extends NMapCalloutOverlay {
    private static final String TAG = NMapCalloutCustomOldOverlay.class.getName();
    ...
    private void adjustTextBounds(NMapView mapView) {
        ...
        if (mTitleTruncated == null || mWidthTitleTruncated != mapViewWidth) {
            ...
            if (DEBUG) {
                Log.i(TAG, "adjustTextBounds: maxWidth=" + maxWidth + ", mMarginX=" + mMarginX + ", mPaddingX="
                        + mPaddingX);
            }
            ...
            if (DEBUG) {
                Log.i(TAG, "adjustTextBounds: mTitleTruncated=" + mTitleTruncated + ", length="
        ...
        if (DEBUG) {
            Log.i(TAG, "adjustTextBounds: mTempRect.width=" + mTempRect.width() + ", mTempRect.height="
                    + mTempRect.height());
        }
